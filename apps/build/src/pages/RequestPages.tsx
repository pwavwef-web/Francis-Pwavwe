...
export function RequestPage() {
  ...
  const fieldsByStep: (keyof RequestFormData)[][] = useMemo(() => [
    ...
    ['preferredTimeline', 'budgetRange', 'preferredContact', 'discoverySource', 'contactConsent', 'smsConsent'],
  ], []);
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      navigate(`/request/success?reference=${encodeURIComponent(result.data.reference)}`, { state: { emailDelayed: result.data.emailDelayed, smsDelayed: result.data.smsDelayed } });
    } catch {
