...
> **Status:** Site built and deployed. All core pages are live in this repository. See [Integration Checklist](#integration-checklist) for remaining tasks (assets, custom domain, Lighthouse audit).
...
- [x] Add a reciprocal link from the productions site back to `francis.html` and `azlearner.me`
...
- [x] Confirm Firebase Auth admin guard works correctly on any admin-only write operations
